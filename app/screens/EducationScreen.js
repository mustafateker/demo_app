...
const EducationScreen = ({ navigation }) => {
  ...
  const handleViewAllCoursesScreen = () => {
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.subTitle}>
            {`${ongoingCourses.length} Devam eden eğitim`}
          </Text>
          <ScrollView
            horizontal
              ...
              >
                ...
                <View style={styles.cardFooter}>
                  ...
                  <Text style={styles.percentageText}>
                    {`${Math.round(course.progress * 100)}% Tamamlandı`}
                  </Text>
                </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={handleViewAllCoursesScreen}>
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    alignItems: "center",
    height: 70,
    position: "relative", // Bu kısmı ekleyin
  },
  headerImage: {
    width: "100%",
    height: 70,
